    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="border-b border-gray-200 bg-slate-400">
        <div className="container mx-auto px-4 py-6 md:py-8">
          ...
          <p className="text-center text-gray-600 mt-2 text-sm sm:text-base">
            Your Daily Dose of Bollywood News & Updates
          </p>
        </div>
      </div>
        ...
        <section className="container mx-auto px-4 py-8 md:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-center">
            ...
            >
              ...
              />
              <div className="absolute top-4 left-4 bg-emerald-600 text-white px-4 py-1 rounded">
                FEATURED
              </div>
            </motion.div>
            <div className="space-y-4 md:space-y-6">
              <div className="text-emerald-600 font-semibold tracking-wider text-sm md:text-base">
                TRENDING NOW
              </div>
              ...
              <Link
                to={`/hot-entertainment/bollywood/article/${featuredArticle._id}`}
                className="inline-block bg-emerald-600 text-white px-6 sm:px-8 py-3 rounded-full hover:bg-gray-800 transition-colors text-sm sm:text-base"
              >
                Read Full Story
              </Link>
            </div>
      ...
      <section className="container mx-auto px-4 py-12 md:py-16">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 md:mb-12 gap-4">
          <h2 className="text-2xl md:text-3xl text-slate-800 text-center font-bold font-serif">Latest Bollywood Stories</h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {categoryData.slice(1).map((article, index) => (
            ...
            >
              ...
              <h3 className="text-lg md:text-xl font-bold text-black mb-2 group-hover:text-emerald-500 transition-colors">
                {article.title}
              </h3>
              ...
              <Link
                ...
                className="text-emerald-500 hover:text-emerald-700 font-medium text-sm md:text-base"
              >
                Continue Reading →
              </Link>
            </motion.article>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-3xl md:text-4xl font-bold font-serif mb-4 md:mb-6">
              Subscribe to Bollywood Updates
            </h3>
            <p className="text-gray-300 mb-6 md:mb-8 text-sm md:text-base">
              Get exclusive access to the latest Bollywood news, celebrity interviews, and behind-the-scenes content delivered right to your inbox.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 sm:px-8 py-3 bg-emerald-600 text-white rounded-full font-semibold hover:bg-emerald-700 transition-all text-sm md:text-base"
              >
                Subscribe Now
              </motion.button>
            </div>
