...
const FormTraditionalArtBollywood = () => {
  ...
  const fetchArts = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/api/traditional-art-bollywood/${id}`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (id) {
        await axios.put(`${API_URL}/api/traditional-art-bollywood/${id}`, form, { headers });
      } else {
        await axios.post(`${API_URL}/api/traditional-art-bollywood`, form, { headers });
      }
...
export default FormTraditionalArtBollywood;