      ...
      <div className="max-w-8xl mx-auto">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 lg:w-3/5 p-6 md:p-12 bg-white rounded-lg shadow-md">
            ...
            {/* Category */}
            <div className="mb-6">
              <span className="bg-red-100 text-red-600 px-3 py-1 rounded-full flex items-center gap-2 w-fit">
            ...
            {/* Description */}
            {article.description && (
              <div className="text-lg text-gray-600 mb-8 border-l-4 border-red-500 pl-6">
                {article.description}
              </div>
            )}
...
export default BollywoodArticleView;