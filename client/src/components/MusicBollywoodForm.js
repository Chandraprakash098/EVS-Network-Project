...
const MusicBollywoodForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (id) {
        await axios.put(`${API_URL}/api/music-bollywood/${id}`, form, { headers });
      } else {
        await axios.post(`${API_URL}/api/music-bollywood`, form, { headers });
      }
...
export default MusicBollywoodForm;