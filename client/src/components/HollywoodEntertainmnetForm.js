...
const HollywoodEntertainmentForm = () => {
  ...
  const fetchEntertainment = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/api/hot-hollywood-entertainment/${id}`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (id) {
        await axios.put(`${API_URL}/api/hot-hollywood-entertainment/${id}`, form, { headers });
      } else {
        await axios.post(`${API_URL}/api/hot-hollywood-entertainment`, form, { headers });
      }
...
export default HollywoodEntertainmentForm